...
**CircleCI 仪表板**：
```
https://app.circleci.com/pipelines/github/qubit-ltd/rs-mixin
```
...
```markdown
[![CircleCI](https://circleci.com/gh/qubit-ltd/rs-mixin.svg?style=svg)](https://circleci.com/gh/qubit-ltd/rs-mixin)
```

或者使用 shields.io 风格：

```markdown
[![CircleCI](https://img.shields.io/circleci/build/github/qubit-ltd/rs-mixin/main?label=build&logo=circleci)](https://circleci.com/gh/qubit-ltd/rs-mixin)
```

效果预览：

![CircleCI Badge](https://img.shields.io/circleci/build/github/qubit-ltd/rs-mixin/main?label=build&logo=circleci)
...
创建 `prism3-rust-core/.cargo-audit.toml`：
...
curl -X POST \
  ...
  https://circleci.com/api/v2/project/gh/qubit-ltd/rs-mixin/pipeline
```
...
- 🐛 Issue：[GitHub Issues](https://github.com/qubit-ltd/rs-mixin/issues)
- 💡 讨论：[GitHub Discussions](https://github.com/qubit-ltd/rs-mixin/discussions)
