...
1. 访问 CircleCI 项目设置：
   ```
   https://app.circleci.com/settings/project/github/qubit-ltd/rs-mixin
   ```
...
2. 访问 Coveralls 仪表板：
   ```
   https://coveralls.io/github/qubit-ltd/rs-mixin
   ```
3. 查看覆盖率报告 🎉
